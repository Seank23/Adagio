...
QtObject {
    ...
    readonly property var fontAwesomeBrand: FontLoader {
        source: "qrc:/res/fonts/Font Awesome 5 Brands-Regular-400.otf"
    }

    readonly property var fontAwesomeRegular: FontLoader {
        source: "qrc:/res/fonts/Font Awesome 5 Pro-Regular-400.otf"
    }

    readonly property var fontAwesomeLight: FontLoader {
        source: "qrc:/res/fonts/Font Awesome 5 Pro-Light-300.otf"
    }

    readonly property var fontAwesomeSolid: FontLoader {
        source: "qrc:/res/fonts/Font Awesome 5 Pro-Solid-900.otf"
    }

    readonly property var contentFontLight: FontLoader {
        source: "qrc:/res/fonts/Nunito-Light.ttf"
    }
    ...
    readonly property var contentFontMedium: FontLoader {
        source: "qrc:/res/fonts/Nunito-Medium.ttf"
    }
}
